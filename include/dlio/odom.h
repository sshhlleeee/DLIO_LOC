...
private:
  ...
  // New callback for initial pose
  void callbackInitialPose(const geometry_msgs::msg::PoseWithCovarianceStamped::SharedPtr pose);
  ...
  // Internal function to set initial pose (used by both auto and manual initialization)
  void setInitialPoseInternal(double x, double y, double z, double qx, double qy, double qz, double qw);
  ...
  // add initial pose subscriber
  rclcpp::Subscription<geometry_msgs::msg::PoseWithCovarianceStamped>::SharedPtr initial_pose_sub_;
  rclcpp::CallbackGroup::SharedPtr lidar_cb_group, imu_cb_group, initial_pose_cb_group_;
  ...
  // add initial pose received flag
  std::atomic<bool> initial_pose_received_;
  ...
  std::vector<std::shared_ptr<const std::vector<Eigen::Matrix4d>>> small_keyframe_normals; //! small_gicp
  std::vector<std::shared_ptr<const nano_gicp::CovarianceList>> nano_keyframe_normals; // nano_gicp
  ...
  pcl::PointCloud<PointType>::Ptr loaded_map_pcd_;
  ...
  //! small_gicp
  std::vector<Eigen::Matrix4d> small_submap_normals;
  std::vector<Eigen::Matrix4d> small_source_normals;
  std::shared_ptr<small_gicp::KdTree<pcl::PointCloud<PointType>>> small_submap_kdtree;
  // nano_gicp
  std::shared_ptr<const nano_gicp::CovarianceList> nano_submap_normals;
  std::shared_ptr<const nanoflann::KdTreeFLANN<PointType>> nano_submap_kdtree;
  ...
  double global_comp_time_sum;
  unsigned long global_comp_frame_count;
  double global_avg_comp_time;
  ...
  std::string gicp_implementation_;
  bool sgicp_use_robust_;

  //! small_gicp
  small_gicp::Registration<small_gicp::RobustFactor<small_gicp::Cauchy, small_gicp::GICPFactor>, small_gicp::ParallelReductionOMP> cauchy_sgicp;
  small_gicp::Registration<small_gicp::GICPFactor, small_gicp::ParallelReductionOMP> sgicp;
  // nano_gicp
  nano_gicp::NanoGICP<PointType, PointType> ngicp;
  nano_gicp::NanoGICP<PointType, PointType> ngicp_temp;
  ...
  // New parameters for localization mode
  bool localization_mode_;
  std::string map_path_;
  
  // Auto initial pose parameters (optional)
  bool use_auto_initial_pose_;
  double auto_initial_pose_x_;
  double auto_initial_pose_y_;
  double auto_initial_pose_z_;
  double auto_initial_pose_qx_;
  double auto_initial_pose_qy_;
  double auto_initial_pose_qz_;
  double auto_initial_pose_qw_;
};
